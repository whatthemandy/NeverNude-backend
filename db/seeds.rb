...
f = Item.create(user: pocket_gopher, section: top, image: open('http://i.imgur.com/Oiel6NA.jpg'))
...
Item.create(user: pocket_gopher, section: top, image: open('http://i.imgur.com/d8Qidp9.jpg'))
...
Item.create(user: pocket_gopher, section: top, image: open('http://i.imgur.com/TOj2m2V.jpg'))
Item.create(user: pocket_gopher, section: top, image: open('http://i.imgur.com/hmHrTy7.jpg'))
Item.create(user: pocket_gopher, section: top, image: open('http://i.imgur.com/ubCWRMn.jpg'))
Item.create(user: pocket_gopher, section: top, image: open('http://i.imgur.com/gRbDoPn.jpg'))
Item.create(user: pocket_gopher, section: top, image: open('http://i.imgur.com/J7iRKLy.jpg'))
...
Item.create(user: pocket_gopher, section: bottom, image: open('http://i.imgur.com/VMin4ks.jpg'))
...
q = Item.create(user: test_user, section: accessory, image: open('http://i.imgur.com/okCyybc.jpg'))
r = Item.create(user: test_user, section: top, image: open('http://i.imgur.com/hmHrTy7.jpg'))
s = Item.create(user: test_user, section: bottom, image: open('http://i.imgur.com/rn7GtuV.jpg'))
t = Item.create(user: test_user, section: footwear, image: open('http://i.imgur.com/1mJSbi6.jpg'))
